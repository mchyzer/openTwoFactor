...
(
  ...
  LAST_UPDATED             INTEGER              NOT NULL,
  VERSION_NUMBER           INTEGER              NOT NULL,
  ATTRIBUTE_VALUE_STRING   varchar(400 ),
...
(
  ...
  REPORT_NAME_SYSTEM    VARCHAR(200)     NOT NULL,
  VERSION_NUMBER        INTEGER                  NOT NULL,
  primary key (uuid)
);
...
(
  ...
  VERSION_NUMBER  INTEGER                        NOT NULL,
  USER_UUID       VARCHAR(40)             NOT NULL,
  REPORT_UUID     VARCHAR(40)             NOT NULL,
  primary key (uuid)
);
...
(
  ...
  TWO_FACTOR_SECRET  VARCHAR(400)         NOT NULL,
  TWO_FACTOR_SECRET_HASH  VARCHAR(100)    NOT NULL
  primary key (UUID)
);
