/* Formatted on 8/19/2021 10:42:20 AM (QP5 v5.252.13127.32847) */
...
AS
   SELECT char_penn_id AS penn_id,
          ...
          CASE
             ...
             WHEN CPV.ALL_ACTIVE_AFFILIATIONS LIKE '%CTWK%' THEN 'T'
...
COMMENT ON COLUMN TF_PERSON_SOURCE_HELPER_V.LAST_FOUR IS 'last four of SSN if we have it';
