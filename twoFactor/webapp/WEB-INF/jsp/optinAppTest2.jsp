...
<title>${textContainer.text['optinAppTestTitle']}</title>
...
<div id="theForm">
  ...
  <form action="UiMain.optinWizardSubmitAppTest2" method="post">
    <div class="paragraphs">

    <h2>${textContainer.text['optinAppTestSubheader2']}</h2>
    <br /><br />
    <%@ include file="../assetsJsp/commonError.jsp"%>
    <br />
    ${textContainer.text['optinAppTestText']}
    <br /><br />
    <br />
    <br />
