...
<title>${textContainer.text['totpAppInstallTitle']}</title>
...
<div id="theForm">
  ...
  <form action="UiMain.totpChangeAppIntegrate" method="post">
    <div class="paragraphs">

    <h2>${textContainer.text['totpAppInstallSubheader']}</h2>
    <br /><br />
