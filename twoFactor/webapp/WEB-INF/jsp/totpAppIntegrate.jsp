...
<title>${textContainer.text['totpAppIntegrateTitle']}</title>
...
<div id="theForm">
  ...
  <form action="UiMain.totpSubmitAppIntegrate" method="post">
    <div class="paragraphs">

    <h2>${textContainer.text['totpAppIntegrateSubheader']}</h2>
    <br /><br />
    ...
    <img src="UiMain.qrCodeCurrent.gif?key=${twoFactorRequestContainer.twoFactorUserLoggedIn.lastUpdated}" height="300" width="300" 
      alt="${textContainer.textEscapeDouble['optinAppIntegrateQrAlt']}" />
    
    <br />
    
    ${textContainer.text['totpAppIntegrateTextBottom']}
