...
<title>${textContainer.text['totpAppConfirmCodeTitle']}</title>
...
<div id="theForm">
  ...
  <form action="UiMain.totpSubmitAppCode" method="post">
    <div class="paragraphs">

    <h2>${textContainer.text['totpAppConfirmCodeSubheader']}</h2>
    <br /><br />
