...
<title>${textContainer.text['totpChangeUploadSecretTitle']}</title>
...
<div id="theForm">
  ...
  <form action="UiMain.totpChangeAppInstall" method="post">
    <div class="paragraphs">

    <h2>${textContainer.text['totpChangeUploadSecretSubheader']}</h2>
    <br /><br />
