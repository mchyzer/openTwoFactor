...
<title>${textContainer.text['totpChangeConfirmCodeTitle']}</title>
...
<div id="theForm">
  ...
  <form action="UiMain.totpChangeSubmitAppCode" method="post">
    <div class="paragraphs">

    <h2>${textContainer.text['totpChangeConfirmCodeSubheader']}</h2>
    <br /><br />
    <%@ include file="../assetsJsp/commonError.jsp"%>
    <br />
    ${textContainer.text['totpChangeConfirmCodeText']}
    <input type="text" name="twoFactorCode" size="12" autocomplete="off" class="textfield" />

    ${textContainer.text['totpChangeConfirmCodeText2']}
