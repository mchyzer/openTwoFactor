...
<div id="theForm">
  ...
  <form action="UiMain.totpChangeSubmitAppIntegrate" method="post">
    ...
    <br />
    ${textContainer.text['totpChangeAppIntegrateText']}
    ...
    ${textContainer.text['totpChangeAppIntegrateTextBottom']}
