 ...
 * @author mchyzer
 */
public enum TwoFactorTransactionType {
  ...
  READONLY_OR_USE_EXISTING {
     ...
     * type
     * @throws TfDaoException if there is a compatibility problem
     */
    @Override
    public void checkCompatibility(TwoFactorTransactionType existingTransactionType)
     ...
     */
    @Override
    public TwoFactorTransactionType transactionTypeToUse() {
      return READONLY_NEW;
    }
  },
  ...
  READ_WRITE_OR_USE_EXISTING {
    ...
    public void checkCompatibility(TwoFactorTransactionType existingTransactionType)
      ...
      if (existingTransactionType != null && existingTransactionType.isReadonly()) {
        throw new TfDaoException("Problem since this transaction type '" 
   ...
   */
  public static TwoFactorTransactionType valueOfIgnoreCase(String string) {
    return TwoFactorServerUtils.enumValueOfIgnoreCase(TwoFactorTransactionType.class,string, false );
  }
   ...
   * @throws TfDaoException if there is a compatibility problem
   */
  public abstract void checkCompatibility(TwoFactorTransactionType existingTransactionType)
    throws TfDaoException;
   ...
   * @return the type to use (e.g. not an if exists one)
   */
  public abstract TwoFactorTransactionType transactionTypeToUse();
