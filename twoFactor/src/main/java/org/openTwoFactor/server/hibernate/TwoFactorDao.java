  ...
  public static void initHibernateIfNotInitted() {
    ...
    synchronized(TwoFactorDao.class) {
      ...
      try {
        ...
        addClass(CFG, TwoFactorReport.class);
        addClass(CFG, TwoFactorReportData.class);
        addClass(CFG, TwoFactorReportPrivilege.class);
        addClass(CFG, TwoFactorReportRollup.class);
