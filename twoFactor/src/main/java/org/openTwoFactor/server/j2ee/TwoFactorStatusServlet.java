...
import org.openTwoFactor.server.status.DiagnosticTask;
import org.openTwoFactor.server.status.DiagnosticType;
import org.openTwoFactor.server.util.TwoFactorServerUtils;
import org.openTwoFactor.server.util.TwoFactorServerVersion;
...
public class TwoFactorStatusServlet extends HttpServlet {
  ...
  static {
    TwoFactorStatusServlet.registerStartup();
  }

  /** logger */
  private static final Log LOG = TwoFactorServerUtils.getLog(TwoFactorStatusServlet.class);
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      result.append(TwoFactorServerUtils.hostname());
      
      String version = null;
      try {
        version =TwoFactorServerVersion.currentVersionString();
      } catch (Exception e) {
      ...
      try {
        ...
        TwoFactorServerUtils.closeQuietly(writer);
      }
