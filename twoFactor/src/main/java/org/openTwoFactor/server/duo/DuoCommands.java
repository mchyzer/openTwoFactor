...
//    }
    ...
    } else if (args.length == 2 && StringUtils.equals("duoBypassCodes", args[0])) {
      String userLookupId = args[1];
//      List<String> codes = duoBypassCodesBySomeId(userLookupId);
...
//   * @return the response object
//   */
//  public static List<String> duoBypassCodesBySomeId(String someId) {
//
//    //user id or netId or whatever
//    if (StringUtils.isBlank(someId)) {
//      throw new RuntimeException("someId is required!");
...
//
//    String userId = retrieveDuoUserIdBySomeId(someId);
//    return duoBypassCodesByUserId(userId);
//  }
//
//  /**
//   * @param userId
//   * @return the response object
//   */
//  public static List<String> duoBypassCodesByUserId(String userId) {
//
//    Map<String, Object> debugMap = new LinkedHashMap<String, Object>();
//
//    debugMap.put("method", "duoBypassCodesByUserId");
//    debugMap.put("userId", userId);
//    long startTime = System.nanoTime();
//    try {
//    
...
//      }
//      
//      debugMap.put("codeCount", codes.size());
//      
//      return resultCodes;
//    } catch (RuntimeException re) {
//      debugMap.put("exception", ExceptionUtils.getFullStackTrace(re));
