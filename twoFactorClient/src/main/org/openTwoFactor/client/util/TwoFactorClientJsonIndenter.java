...
/*
 * @author mchyzer
 * $Id: TwoFactorClientJsonIndenter.java,v 1.1 2013/06/20 06:15:21 mchyzer Exp $
 */
 ...
 */
public class TwoFactorClientJsonIndenter {
   ...
   * indenter
   */
  public TwoFactorClientJsonIndenter(String theJson) {
    if (theJson != null) {
      this.json = TwoFactorClientUtils.trimToEmpty(theJson);
    }
  }
