...
/*
 * @author mchyzer
 * $Id: TwoFactorClientXmlIndenter.java,v 1.1 2013/06/20 06:15:22 mchyzer Exp $
 */
 ...
 */
public class TwoFactorClientXmlIndenter {
  ...
  public String result() {
    ...
    return TwoFactorClientUtils.trim(this.result.toString());
  }
  ...
  private void newlineIndent() {
    this.result.append("\n").append(TwoFactorClientUtils.repeat("  ", this.currentNumberOfIndents));
  }
  ...
  static boolean textTag(String xml, int endTagIndex, String tagName, 
    ...
    if (TwoFactorClientUtils.equals(tagName, nextTagName) && isNextCloseTag) {
      return true;
    }
    return false;
  }
   ...
   * indenter
   */
  public TwoFactorClientXmlIndenter(String theXml) {
    if (theXml != null) {
      this.xml = TwoFactorClientUtils.trimToEmpty(theXml);
    }
  }
