 ...
 */
package org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters;
 ...
 * should be thrown.</p>
 * <p/>
 * <p>If working with the high level {@link org.openTwoFactor.clientExt.com.thoughtworks.xstream.XStream} facade,
 * you can register new converters using the XStream.registerConverter() method.</p>
 * <p/>
 * <p>If working with the lower level API, the
 * {@link org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.ConverterLookup} implementation is
 ...
 * should implement {@link org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.SingleValueConverter}.
 * <p>{@link org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.basic.AbstractSingleValueConverter}
 * provides a starting point.</p>
 * <p/>
 * <p>{@link org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.collections.AbstractCollectionConverter}
 * provides a starting point for objects that hold a collection of other objects
 * (such as Lists and Maps).</p>
 *
 * @author Joe Walnes
 * @see org.openTwoFactor.clientExt.com.thoughtworks.xstream.XStream
 * @see org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.ConverterLookup
 * @see org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.basic.AbstractSingleValueConverter
 * @see org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.collections.AbstractCollectionConverter
 */
