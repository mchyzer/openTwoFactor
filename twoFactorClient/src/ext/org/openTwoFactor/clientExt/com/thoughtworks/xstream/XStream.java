 ...
 */
package org.openTwoFactor.clientExt.com.thoughtworks.xstream;
...
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.alias.ClassMapper;
...
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.ConverterRegistry;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.DataHolder;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.SingleValueConverter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.SingleValueConverterWrapper;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.basic.BigDecimalConverter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.basic.BigIntegerConverter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.basic.BooleanConverter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.basic.ByteConverter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.basic.CharConverter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.basic.DateConverter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.basic.DoubleConverter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.basic.FloatConverter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.basic.IntConverter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.basic.LongConverter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.basic.NullConverter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.basic.ShortConverter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.basic.StringBufferConverter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.basic.StringConverter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.basic.URLConverter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.collections.ArrayConverter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.collections.BitSetConverter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.collections.CharArrayConverter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.collections.CollectionConverter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.collections.MapConverter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.collections.PropertiesConverter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.collections.TreeMapConverter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.collections.TreeSetConverter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.extended.ColorConverter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.extended.DynamicProxyConverter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.extended.EncodedByteArrayConverter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.extended.FileConverter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.extended.FontConverter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.extended.GregorianCalendarConverter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.extended.JavaClassConverter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.extended.JavaMethodConverter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.extended.LocaleConverter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.extended.LookAndFeelConverter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.extended.SqlDateConverter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.extended.SqlTimeConverter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.extended.SqlTimestampConverter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.extended.TextAttributeConverter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.reflection.ExternalizableConverter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.reflection.ReflectionConverter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.reflection.ReflectionProvider;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.reflection.SelfStreamingInstanceChecker;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.reflection.SerializableConverter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.core.DefaultConverterLookup;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.core.JVM;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.core.MapBackedDataHolder;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.core.ReferenceByIdMarshallingStrategy;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.core.ReferenceByXPathMarshallingStrategy;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.core.TreeMarshallingStrategy;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.core.util.ClassLoaderReference;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.core.util.CompositeClassLoader;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.core.util.CustomObjectInputStream;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.core.util.CustomObjectOutputStream;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.io.HierarchicalStreamDriver;
...
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.io.StatefulWriter;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.io.xml.XppDriver;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.mapper.AnnotationConfiguration;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.mapper.ArrayMapper;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.mapper.AttributeAliasingMapper;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.mapper.AttributeMapper;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.mapper.CachingMapper;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.mapper.ClassAliasingMapper;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.mapper.DefaultImplementationsMapper;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.mapper.DefaultMapper;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.mapper.DynamicProxyMapper;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.mapper.FieldAliasingMapper;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.mapper.ImmutableTypesMapper;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.mapper.ImplicitCollectionMapper;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.mapper.LocalConversionMapper;
...
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.mapper.OuterClassMapper;
import org.openTwoFactor.clientExt.com.thoughtworks.xstream.mapper.XStream11XmlFriendlyMapper;
 ...
 * <p/>
 * <p>
 * XStream contains a map of {@link org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.Converter} instances, each
 ...
 * non-standard converters are supplied in the {@link org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.extended}
 * package and you can create your own by implementing the
 * {@link org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.Converter} interface.
 * </p>
 * <p/>
 * <p>
 * <hr>
 ...
 * {@link org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.reflection.ReflectionConverter} as the initial default
 * converter.
 * </p>
 * <p/>
 * <p>
...
public class XStream {
    ...
    private static final String ANNOTATION_MAPPER_TYPE = "org.openTwoFactor.clientExt.com.thoughtworks.xstream.mapper.AnnotationMapper";
    ...
    private Mapper buildMapper() {
        ...
        if (jvm.loadClass("org.openTwoFactor.clientExt.net.sf.cglib.proxy.Enhancer") != null) {
            mapper = buildMapperDynamically(
                     "org.openTwoFactor.clientExt.com.thoughtworks.xstream.mapper.CGLIBMapper",
        ...
        if (JVM.is15()) {
            mapper = buildMapperDynamically(
                "org.openTwoFactor.clientExt.com.thoughtworks.xstream.mapper.EnumMapper",
    ...
    protected void setupConverters() {
        ...
        if (jvm.loadClass("javax.security.auth.Subject") != null) {
            dynamicallyRegisterConverter(
                    "org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.extended.SubjectConverter",
        ...
        if (jvm.loadClass("javax.xml.datatype.Duration") != null) {
            dynamicallyRegisterConverter(
                    "org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.extended.DurationConverter",
        ...
        if (JVM.is14()) {
            ...
            dynamicallyRegisterConverter(
                    "org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.extended.ThrowableConverter",
                    PRIORITY_NORMAL, new Class[]{Converter.class},
                    new Object[]{reflectionConverter});
            dynamicallyRegisterConverter(
                    "org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.extended.StackTraceElementConverter",
                    PRIORITY_NORMAL, null, null);
            dynamicallyRegisterConverter(
                    "org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.extended.CurrencyConverter",
                    PRIORITY_NORMAL, null, null);
            dynamicallyRegisterConverter(
                    "org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.extended.RegexPatternConverter",
                    PRIORITY_NORMAL, new Class[]{Converter.class},
                    new Object[]{reflectionConverter});
            dynamicallyRegisterConverter(
                    "org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.extended.CharsetConverter",
                    PRIORITY_NORMAL, null, null);
        }
        ...
        if (JVM.is15()) {
            // late bound converters - allows XStream to be compiled on earlier JDKs
            dynamicallyRegisterConverter(
                    "org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.enums.EnumConverter", PRIORITY_NORMAL,
                    null, null);
            dynamicallyRegisterConverter(
                    "org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.enums.EnumSetConverter", PRIORITY_NORMAL,
                    new Class[]{Mapper.class}, new Object[]{mapper});
            dynamicallyRegisterConverter(
                    "org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.enums.EnumMapConverter", PRIORITY_NORMAL,
                    new Class[]{Mapper.class}, new Object[]{mapper});
            dynamicallyRegisterConverter(
                "org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.basic.StringBuilderConverter", PRIORITY_NORMAL,
                null, null);
            dynamicallyRegisterConverter(
                "org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.basic.UUIDConverter", PRIORITY_NORMAL,
                null, null);
        }

        if (jvm.loadClass("org.openTwoFactor.clientExt.net.sf.cglib.proxy.Enhancer") != null) {
            dynamicallyRegisterConverter(
                    "org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.reflection.CGLIBEnhancedConverter",
    ...
    protected void setupImmutableTypes() {
        ...
        if (JVM.is14()) {
            ...
            Class type = jvm.loadClass("org.openTwoFactor.clientExt.com.thoughtworks.xstream.converters.extended.CharsetConverter");
     ...
     * </p>
     *
     * @see #createObjectOutputStream(org.openTwoFactor.clientExt.com.thoughtworks.xstream.io.HierarchicalStreamWriter, String)
     * @see #createObjectInputStream(org.openTwoFactor.clientExt.com.thoughtworks.xstream.io.HierarchicalStreamReader)
     * @since 1.0.3
     */
