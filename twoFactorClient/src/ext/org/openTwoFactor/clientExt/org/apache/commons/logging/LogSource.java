...
import org.openTwoFactor.clientExt.org.apache.commons.logging.impl.NoOpLog;
 ...
 *     <code>org.openTwoFactor.clientExt.org.apache.commons.logging.impl.NoOpLog</code>.</li>
 * </ul>
 *
 * <p>You can change the default behavior in one of two ways:</p>
 * <ul>
 * <li>On the startup command line, set the system property
 *     <code>org.openTwoFactor.clientExt.org.apache.commons.logging.log</code> to the name of the
 *     <code>org.openTwoFactor.clientExt.org.apache.commons.logging.Log</code> implementation class
 *     you want to use.</li>
 ...
 *
 * @author Rod Waldhoff
 * @version $Id: LogSource.java,v 1.1 2013/06/20 06:16:04 mchyzer Exp $
 */
public class LogSource {
    ...
    static {
        ...
        // Is Log4J Available?
        try {
            if (null != Class.forName("org.openTwoFactor.clientExt.org.apache.log4j.Logger")) {
        ...
        try {
            if ((null != Class.forName("java.util.logging.Logger")) &&
                (null != Class.forName("org.openTwoFactor.clientExt.org.apache.commons.logging.impl.Jdk14Logger"))) {
        ...
        String name = null;
        try {
            name = System.getProperty("org.openTwoFactor.clientExt.org.apache.commons.logging.log");
            if (name == null) {
                name = System.getProperty("org.openTwoFactor.clientExt.org.apache.commons.logging.Log");
            }
        } catch (Throwable t) {
        ...
        if (name != null) {
            try {
                ...
                try {
                    setLogImplementation
                            ("org.openTwoFactor.clientExt.org.apache.commons.logging.impl.NoOpLog");
                } catch (Throwable u) {
                    ;
                }
            }
            ...
            try {
                if (log4jIsAvailable) {
                    setLogImplementation
                            ("org.openTwoFactor.clientExt.org.apache.commons.logging.impl.Log4JLogger");
     ...
     * <tt>org.openTwoFactor.clientExt.org.apache.commons.logging.log</tt> property.
     * The value of <tt>org.openTwoFactor.clientExt.org.apache.commons.logging.log</tt> may be set to
     ...
     * <p>
     * When <tt>org.openTwoFactor.clientExt.org.apache.commons.logging.log</tt> is not set,
